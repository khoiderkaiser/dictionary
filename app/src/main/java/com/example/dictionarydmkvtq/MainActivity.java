...
import com.example.dictionarydmkvtq.Adapters.MeaningAdapter;
import com.example.dictionarydmkvtq.Adapters.PhoneticsAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final OnFetchDataListener listener = new OnFetchDataListener() {
        ...
        public void onFetchData(APIResponse apiResponse, String message) {
            ...
            if (apiResponse == null) {
                Toast.makeText(MainActivity.this, "No data found, dude", Toast.LENGTH_SHORT).show();
                return;
            }
